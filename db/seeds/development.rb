...
3.times do
    Category.create!( title: Faker::Lorem.sentence(word_count: 2) )   
  end  
  ...
  category = []
    3.times do
      ...
      post = Post.new( title: Faker::Lorem.sentence(word_count: 2), description: Faker::Lorem.paragraphs(number: 1),
